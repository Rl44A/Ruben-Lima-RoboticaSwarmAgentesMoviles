...
import time 
import math
import AlphabotRaspi
from AlphabotRaspi import zero2
       ...
       with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as tcp_obj:
            ...
            while(rep<15):
                ...
                if(coordinates[1:19] =='onnected to the Ro'):
                    ...
                    print(rep)
                    if (rep ==8):
                        #DatosRobot.to_excel('Alpha-Exp-sphere.xlsx', sheet_name='Prueba2', index=False)
                        print("Guardando a Excel")
                    

                
Conexion_RobotatZW(4)   
